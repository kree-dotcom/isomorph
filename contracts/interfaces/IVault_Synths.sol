interface IVault_Synths {
  ...
  function moUSDLoanAndInterest ( address, address ) external view returns ( uint256 );
  ...
  function priceCollateralToUSD ( bytes32 _currencyKey, uint256 _amount, uint8 _assetType ) external view returns ( uint256 );
